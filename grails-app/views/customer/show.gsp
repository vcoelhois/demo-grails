	...
	<body>
		...
		<div id="show-customer" class="content scaffold-show" role="main">
			...
			<ol class="property-list customer">
				...
				<g:if test="${customerInstance?.contactName}">
				<li class="fieldcontain">
					<span id="contactName-label" class="property-label"><g:message code="customer.contactName.label" default="Contact Name" /></span>
					
						<span class="property-value" aria-labelledby="contactName-label"><g:fieldValue bean="${customerInstance}" field="contactName"/></span>
